...
const AZURE_CONTAINER_WEBIMAGE = process.env.AZURE_CONTAINER_WEBIMAGE || "";
...
const containerClient = blobServiceClient.getContainerClient(AZURE_CONTAINER_WEBIMAGE);
...
// API สำหรับอัปโหลดไฟล์เว็บอิมเมจ
...
async function ensureContainerExists() {
  ...
  if (!exists) {
    ...
    console.log(`✅ Created container: ${AZURE_CONTAINER_WEBIMAGE}`);
  }
}
