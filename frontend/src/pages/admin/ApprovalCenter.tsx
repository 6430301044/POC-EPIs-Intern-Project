...
import ReferenceApproval from "./ReferenceApproval";

export default function ApprovalCenter() {
  const [activeTab, setActiveTab] = useState<"user" | "file" | "reference">("user");
