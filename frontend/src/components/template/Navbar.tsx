...
export default function Navbar() {
  ...
  return (
    <>
      ...
      {/* Navbar หลัก */}
      <div className="fixed top-[50px] w-full z-40 bg-[rgba(0,0,0,0.5)] text-white shadow-sm border-b-[0.5px] border-white">
        <div className="container px-8 py-4 mx-auto xl:px-0">
          <nav className="relative flex flex-wrap items-center justify-between mx-auto lg:justify-between max-w-screen-xl">
            ...
            <button
              ...
              className="px-2 py-1 text-gray-500 dark:text-gray-400 rounded-md lg:hidden hover:text-indigo-500 dark:hover:text-indigo-400 focus:text-indigo-500 focus:bg-indigo-100 dark:focus:bg-gray-800 focus:outline-none"
            >
