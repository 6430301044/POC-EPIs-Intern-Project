    ...
    <div className="relative bg-gray-200 dark:bg-gray-800">
      <Container>
        <div className="grid max-w-screen-xl grid-cols-1 gap-10 pt-10 mx-auto mt-5 lg:grid-cols-5">
          <div className="lg:col-span-2">
            ...
            <div className="max-w-md mt-4 text-gray-600 dark:text-gray-400">
              EPIs is a Report website for Enviroment Data. Lorem ipsum dolor
              sit, amet consectetur adipisicing elit. Qui laborum praesentium
              doloribus quis, accusamus ipsa atque aut, ipsum ex beatae
              perferendis rerum?
            </div>
          </div>
        ...
        <div className="my-10 text-sm text-center text-gray-600 dark:text-gray-400">
          เว็บไซต์นี้เป็น POC (Proof Of Concept) Project ระหว่าง หน่วยงาน บอก.
          และ ม.เกษตรศาสตร์ ว.ศรีราขา Copyright © {new Date().getFullYear()}.
          จัดทำ ♥ โดย นักศึกษา ม.เกษตรศาสตร์
        </div>
      </Container>
    </div>
  );
